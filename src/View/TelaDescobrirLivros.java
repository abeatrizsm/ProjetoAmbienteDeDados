...
public class TelaDescobrirLivros extends JFrame {
    ...
    public TelaDescobrirLivros() {

        setTitle("Descobrir Livros");
        setSize(1000, 700);
        ...
        botaoAlugar.setFont(fonteBotao);
        botaoAlugar.setBackground(azulMedio);
        botaoAlugar.setForeground(branco);
        botaoAlugar.setPreferredSize(tamanhoBotao);
        botaoAlugar.setFocusPainted(false);

        botoesBusca.add(botaoBuscar);
        botoesBusca.add(botaoAlugar);
        ...
        botaoAlugar.addActionListener(evt -> botaoAlugarPerformed(evt));

        setVisible(true);
    }

    public void botaoAlugarPerformed(java.awt.event.ActionEvent evt) {
        try {
